...
INSERT INTO sgd.roles (id, nombre, operaciones) VALUES(3, 'Director de carrera', 0x020304050607080F1011121314);
...
INSERT INTO sgd.usuarios_SEQ (next_val) VALUES (8);
...
insert into sgd.unidades_curriculares_SEQ(next_val) values (1);
...
insert into sgd.programas_SEQ(next_val) values (1);
...
insert into sgd.marcos_SEQ(next_val) values (1);
...
insert into sgd.integrantes_SEQ(next_val) values (1);
...
insert into sgd.bibliografia_SEQ(next_val) values (1);
