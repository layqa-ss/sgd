...
INSERT INTO sgd.roles (id, nombre, operaciones) VALUES(8, 'Externo', NULL);

INSERT INTO sgd.roles_SEQ (next_val) VALUES (9);

INSERT INTO sgd.usuarios (creationDate, id, fullname, username, id_rol, tipoAdscripcion) VALUES('2024-11-13 00:00:00', 1, 'Director Lic Educación', 'director.educacion', 3, 1);
INSERT INTO sgd.usuarios (creationDate, id, fullname, username, id_rol, tipoAdscripcion) VALUES('2024-11-13 00:00:00', 2, 'Docente Lic Educacion', 'docente.educacion', 2, 1);
INSERT INTO sgd.usuarios (creationDate, id, fullname, username, id_rol, tipoAdscripcion) VALUES('2024-11-13 00:00:00', 3, 'Administrador', 'admin', 1, 2);
INSERT INTO sgd.usuarios (creationDate, id, fullname, username, id_rol, tipoAdscripcion) VALUES('2024-11-13 00:00:00', 4, 'Bedelias', 'bedelias', 5, 2);
INSERT INTO sgd.usuarios (id, creationDate, fullname, tipoAdscripcion, username, id_rol) VALUES(5, '2024-11-18 13:56:00.198000', 'Admin Inst Educación', 0, 'admin.educacion', 4);
INSERT INTO sgd.usuarios (id, creationDate, fullname, tipoAdscripcion, username, id_rol) VALUES(6, '2024-11-18 13:56:27.574000', 'Comisiones', 2, 'comisiones', 6);
INSERT INTO sgd.usuarios (id, creationDate, fullname, tipoAdscripcion, username, id_rol) VALUES(7, '2024-11-18 13:56:49.111000', 'Gobierno', 2, 'gobierno', 7);
INSERT INTO sgd.usuarios (creationDate, id, fullname, username, id_rol, tipoAdscripcion) VALUES('2025-01-13 00:00:00', 9, 'Test User', 'test.user', 1, 2);
...
INSERT INTO sgd.configuraciones (id, config, value, isDate) VALUES(1, 1, '01/01/2025', 1);
INSERT INTO sgd.configuraciones (id, config, value, isDate) VALUES(2, 2, '31/12/2025', 1);
...
INSERT INTO sgd.configuraciones (id, config, value, isDate) VALUES(4, 4, 'El estudiante que no alcanzare la calificación mínima requerida (Aceptable) en una sola de las evaluaciones durante el curso —cualquiera que esta evaluación fuere—, ya sea para su aprobación directa o para ganar el derecho a aprobar mediante una evaluación final, tendrá derecho a la realización de una prueba de recuperación, que sustituirá a la referida instancia de evaluación.', 0);
INSERT INTO sgd.configuraciones (id, config, value, isDate) VALUES(5, 5, 'Examen libre: para la aprobación de las unidades curriculares de carácter teórico, podrán rendir un examen libre aquellos estudiantes inscriptos al mismo. El examen versará sobre la totalidad del Programa del último curso impartido. Para aprobar la unidad curricular, el estudiante deberá alcanzar una calificación mínima de Aceptable en dicha evaluación.', 0);

insert into sgd.configuraciones_SEQ(next_val) values (6);
